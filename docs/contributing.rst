...
In order to ensure that we can keep distributing DynaSched under our
...
code in DynaSched.  This means being able to ensure that all code
included in DynaSched is free, open source, and able to be distributed
under :doc:`the BSD license </license>`.

DynaSched has therefore adopted requirements based on the signed-off-by
process as described in Section 11 of the Linux kernel document on
`Submitting Patches
<https://www.kernel.org/doc/html/latest/process/submitting-patches.html#sign-your-work-the-developer-s-certificate-of-origin>`_.
Each proposed contribution to the DynaSched code base must include the
...
indicates agreement to the Developer's Certificate of Origin:
    ...
    #. The contribution was created in whole or in part by me and I
       have the right to submit it under the :doc:`DynaSched open
    ...
    #. The contribution is based upon previous work that, to the best
       ...
       me, under the :doc:`DynaSched open source license
...
certification will not be accepted into any DynaSched code
...
.. note:: This policy prevents a situation where intellectual property
          gets into the DynaSched code base and then someone later
          claims that we owe them money for it.  DynaSched is a free,
